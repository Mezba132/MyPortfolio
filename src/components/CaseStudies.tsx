        ...
        <div className="space-y-12">
          {caseStudies.map((cs) => (
            <motion.div
              ...
              className="p-8 sm:p-10 rounded-3xl bg-[#0a0f1d] border border-white/10 shadow-2xl space-y-8 relative overflow-hidden backdrop-blur-md"
            >
              {/* Top Banner & Header */}
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-6 border-b border-white/10">
                ...
                <div className="flex flex-wrap gap-2">
                  {cs.techStack.map((tech, i) => (
                    <span
                      key={i}
                      className="px-3 py-1 rounded-xl bg-white/5 text-xs font-bold text-indigo-300 border border-white/10"
                    >
                      {tech}
                    </span>
                  ))}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="p-5 rounded-2xl bg-indigo-950/40 border border-indigo-500/20 space-y-2">
                  <h4 className="text-xs font-bold uppercase tracking-widest text-indigo-300 flex items-center gap-2">
              ...
              <div className="p-6 rounded-2xl bg-indigo-900/40 text-white border border-indigo-500/30">
                <h4 className="text-xs font-bold uppercase tracking-widest text-indigo-300 mb-2 flex items-center gap-2">
