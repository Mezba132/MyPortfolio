        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-16">
          ...
          >
            ...
            <div className="pt-4 border-t border-white/5">
              <h4 className="text-xs font-bold uppercase tracking-widest text-slate-400 mb-3">Core Qualities & Leadership</h4>
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {qualities.map((item, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-2 p-2.5 rounded-2xl bg-white/5 border border-white/5 text-xs font-medium text-slate-300"
                  >
          ...
          >
            <div className="p-8 rounded-3xl bg-gradient-to-br from-indigo-900/40 via-[#0a0f1d] to-[#0a0f1d] text-white border border-indigo-500/30 shadow-2xl space-y-4 flex-1 flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-12 h-12 rounded-2xl bg-indigo-500/20 text-indigo-400 flex items-center justify-center font-bold text-xl border border-indigo-500/30">
                    <Lightbulb className="w-6 h-6" />
                  </div>
                  <div>
                    <h4 className="font-bold text-lg text-white font-display">Engineering Philosophy</h4>
                    <p className="text-xs text-indigo-300">Maintainable, Tested, & High Performance</p>
                  </div>
                </div>
            ...
            <div className="p-6 rounded-3xl bg-white/5 border border-white/10 backdrop-blur-md space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h4 className="font-bold text-sm text-white">Client & Team Collaboration</h4>
                  <p className="text-[11px] text-slate-400">Proactive Communication</p>
                </div>
              </div>
