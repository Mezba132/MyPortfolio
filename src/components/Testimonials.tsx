        ...
        {current && (
          <div className="max-w-4xl mx-auto">
            <motion.div
              ...
              className="p-8 sm:p-12 rounded-3xl bg-[#0a0f1d] border border-white/10 shadow-2xl relative overflow-hidden space-y-6 backdrop-blur-md"
            >
              ...
              <div className="flex items-center gap-1">
                ...
                <span className="ml-2 text-xs font-bold font-mono text-slate-400">5.0 / 5.0</span>
              </div>

              {/* Quote Content */}
              <blockquote className="text-base sm:text-lg text-slate-200 font-light leading-relaxed italic font-serif">
                "{current.comment}"
              </blockquote>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 pt-6 border-t border-white/5">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="p-3 rounded-2xl bg-white/5 border border-white/10 text-white hover:bg-indigo-600 transition-colors cursor-pointer"
              ...
              {testimonials.map((_, i) => (
                <button
                  ...
                  className={`h-2.5 rounded-full transition-all cursor-pointer ${
                    currentIndex === i ? 'w-8 bg-indigo-500' : 'w-2.5 bg-white/10'
                  }`}
                />
              ))}
            </div>
