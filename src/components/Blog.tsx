    ...
    <section id="blogs" className="py-20 relative overflow-hidden">
      <div className="w-[90%] mx-auto px-4 sm:px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-10">
          {/* Tags */}
          <div className="flex items-center gap-2 overflow-x-auto w-full md:w-auto pb-2 md:pb-0 scrollbar-none bg-white/5 p-1.5 rounded-2xl border border-white/10 backdrop-blur-md">
            {allTags.map((tag) => (
              <button
                key={tag}
          ...
          <div className="relative w-full md:w-72 shrink-0">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-2xl bg-white/5 border border-white/10 text-xs font-semibold text-white placeholder-slate-500 focus:outline-none focus:border-indigo-500 backdrop-blur-md"
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredBlogs.map((post, idx) => (
            <motion.div
              ...
              className="p-6 rounded-3xl bg-[#0a0f1d] border border-white/10 shadow-2xl hover:border-indigo-500/50 transition-all duration-300 hover:-translate-y-1.5 cursor-pointer group flex flex-col justify-between backdrop-blur-md"
            >
              <div className="space-y-4">
                ...
                <h3 className="text-lg font-bold text-white font-display group-hover:text-indigo-400 transition-colors leading-snug">
                  {post.title}
                </h3>
              ...
              <div className="pt-4 mt-4 border-t border-white/5 flex items-center justify-between text-xs font-bold text-slate-400">
